...
class GameFragment : Fragment() {
    ...
    private fun prosseguir() {
        val pontos = fragmentGameBinding.questionTv.text.toString().toInt()
        val i = Intent(this.context, ResultActivity::class.java)
    ...
    override fun onCreateView(
        ...
        fragmentGameBinding.icProsseguir.setOnClickListener { prosseguir()}
